...
- **Read:** `project.md`, the plan file in `.forge/memory/plans/` (your task section, owned by planner), `.forge/memory/backend-dev.md` for API contracts if needed
- **Write:** `.forge/memory/frontend-dev.md`
