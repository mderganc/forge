...
If `graphify-out/` exists: read `graphify-out/GRAPH_REPORT.md` before grep/glob/semantic search; follow every **GRAPHIFY** block on each step; after code edits run `graphify update .`.
