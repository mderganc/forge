...
Organize **intent** before `forge develop`. This is not solution brainstorming (no SCAMPER/Pugh here). Develop owns investigation, solution families, and `docs/forge/specs/*-design.md`.
